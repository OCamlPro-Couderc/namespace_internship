...
celui de la compilation. Un programme est rarement consistitué d'un seul fichier
...
provient le module. Cette information n'est utilisé qu'à la normalisation des
...
idées mais sans jamais aucun accord entre les participants. Bien qu'il n'apporte
pas un gain évident en expressivité, il permet plus de confort pour le
...
manière dont sont installées celles-ci dans le système de fichiers, et permet
également de simplifier le travail du compilateur sans nécessiter d'outils
externes (le moins possible en tout cas).
...
fonctionnalités dans le but de pouvoir intégrer cette mécanique au langage.
